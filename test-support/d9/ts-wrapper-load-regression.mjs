...
const args = ["--module", "node16", "--target", "es2022", "--moduleResolution", "node16", "--skipLibCheck", "--outDir", output, join(source, "bass-plan-ado-operation.ts"), join(source, "bass-execute-confirmed-ado-operation.ts"), join(root, "test-support", "d9", "opencode-plugin-shim.d.ts")];

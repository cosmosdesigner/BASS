...
const args = ["--module", "node16", "--target", "es2022", "--moduleResolution", "node16", "--skipLibCheck", "--outDir", output, ...names.map(([file]) => join(root, "integration", "opencode", "plugins", `${file}.ts`)), join(root, "support", "test-support", "d9", "opencode-plugin-shim.d.ts")]

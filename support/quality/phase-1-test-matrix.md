...
| D4 OpenCode foundation | `BASS/adapters/opencode/` agents, commands, and plugins | Confirm target-host discovery and installation compatibility | BASS owner | source_ready |
